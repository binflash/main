...
'	  <title>Flashbin</title>'.
'   <link rel="icon" sizes="48x48" href="https://imgur.com/ESxvNJ9.png">'.
'    <style>'.
'    body {'.
...
'	width: 140px;'.
'	}'.
'#sideNav .navHead { font-weight: bold; font-size: 13px; padding: 6px 0px 1px 0px; }'.
'#sideNav .navBody { line-height: 15px; }'.
'#sideNav .navDivider {'.
'	font-size: 5px;'.
...
'	}'.
''.
'.vMiniEntry img { margin-bottom: 4px; }'.
''.
'.vMicroEntry {'.
'	width: 90px;'.
'	margin-bottom: 6px;'.
...
''.
'#hpEmbedTopCap { height: 35px; overflow: hidden; }'.
...
'	font-weight: bold;'.
'	}'.
'#ibNav .selected { background: #CCC; }'.
''.
'#ibContent { border: 3px solid #CCC; }'.
''.
'#ibSubmitDiv { margin-top: 12px; }'.
''.
'#ibFilterDiv { margin-top: 12px; }'.
'#ibFilterSelect { font-size: 11px; }'.
''.
'/* .ibTable { background-color: none; } removing this because there is no value of "none" */'.
''.
'tr.ibTableHeader { background-color: #CCC; }'.
''.
'tr.ibTableMain { background-color: #FFF; }'.
''.
'a.ibLink:hover {'.
'	color: #03C;'.
'	font-family: Arial, Helvetica, sans-serif;'.
...
'.catImage { float: left; }'.
''.
'.categoryHeaders { margin-left: 85px; }'.
''.
'.categoryContent {'.
'	clear: left;'.
...
''.
''.
'.displayPostTable { border: 1px solid #CCCCCC; }'.
''.
...
''.
'/*'.
'     FILE ARCHIVED ON 10:20:55 Aug 26, 2006 AND RETRIEVED FROM THE'.
'     INTERNET ARCHIVE ON 04:36:06 Apr 29, 2023.'.
...
'/*'.
'playback timings (ms):'.
'  captures_list: 139.182'.
'  exclusion.robots: 0.06'.
'  exclusion.robots.policy: 0.053'.
'  cdx.remote: 0.054'.
'  esindex: 0.007'.
'  LoadShardBlock: 120.369 (3)'.
'  PetaboxLoader3.datanode: 132.677 (4)'.
'  load_resource: 64.281'.
'  PetaboxLoader3.resolve: 47.625'.
'*/'.
'</style>'.
'<div id="baseDiv">'.
'			<div id="logoTagDiv">'.
'		<a href="/web/20060831010548/http://www.youtube.com/"><img src="https://imgur.com/wXL1bwq.png" alt="YouTube" width="254" height="48" border="0"></a>'.
'	</div>'.
''.
'	<div id="utilDiv" style="border:0px solid #333;height:13px">'.
'                        <a href="/web/20060831010548/http://www.youtube.com/signup"><strong>Sign Up</strong></a>'.
'                        <span class="utilDelim">|</span>'.
'                        <a href="/web/20060831010548/http://www.youtube.com/my_account">My Account</a>'.
'                        <span class="utilDelim">|</span>'.
'                        <a href="/web/20060831010548/http://www.youtube.com/t/help_center">Help</a>'.
'                        <span class="utilDelim">|</span>'.
'                        <a href="/web/20060831010548/http://www.youtube.com/login?next=/%3F">Log In</a>'.
'        </div>'.
'        <form name="logoutForm" method="post" action="/web/20060831010548/http://www.youtube.com/index">'.
'                <input type="hidden" name="action_logout" value="1">'.
'        </form>'.
''.
'	'.
'	<div id="searchDiv">'.
'			<form name="searchForm" id="searchForm" method="get" action="/web/20060831010548/http://www.youtube.com/results">'.
...
'				<a href="/web/20060831010548/http://www.youtube.com/index">Home</a>'.
'				</div>'.
'				</div>'.
'				'.
'				<div class="tab">'.
...
'				<a href="/web/20060831010548/http://www.youtube.com/browse?s=mp">Toons</a>'.
'				</div>'.
'				</div>'.
'				'.
'				<div class="tab">'.
...
'				<b class="rc5"></b>'.
'				</b> <div class="tabContent">'.
'				<a href="/web/20060831010548/http://www.youtube.com/members">Games</a>'.
'				</div>'.
'				</div>'.
'				'.
'				<div class="tab">'.
...
'				<b class="rc5"></b>'.
'				</b> <div class="tabContent">'.
'				<a href="/web/20060831010548/http://www.youtube.com/categories">Portal</a>'.
'				</div>'.
'				</div>'.
'				'.
'				<div class="rtab">'.
...
'				<b class="rc5"></b>'.
'				</b> <div class="tabContent">'.
'				<a href="/web/20060831010548/http://www.youtube.com/my_videos_upload">Upload</a>'.
'				</div>'.
'				</div>'.
'		</div>'.
'	</td></tr>'.
...
'				<a href="/web/20060831010548/http://www.youtube.com/my_videos">My Flashes</a>'.
'						<span style="padding: 0px 8px;">|</span>'.
'				<a href="/web/20060831010548/http://www.youtube.com/my_favorites">My Favorites</a>'.
'						<span style="padding: 0px 8px;">|</span>'.
'				<a href="/web/20060831010548/http://www.youtube.com/my_friends?sort=n">My Friends</a>'.
'						<span style="padding: 0px 8px;">|</span>'.
'				<a href="/web/20060831010548/http://www.youtube.com/groups_my">My Groups</a>'.
'						<span style="padding: 0px 8px;">|</span>'.
'				<a href="/web/20060831010548/http://www.youtube.com/my_profile">My Messages</a>'.
'			&nbsp;'.
'		</div>'.
'	</td></tr>'.
'	</tbody></table>'.
